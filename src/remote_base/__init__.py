...
(
    MovistarData,
    MovistarBinarySensor,
    MovistarTrigger,
    MovistarAction,
    MovistarDumper,
) = declare_protocol("Movistar")
MOVISTAR_SCHEMA = cv.Schema(
    {
        cv.Required(CONF_STATE): cv.boolean,
...
@register_binary_sensor("movistar", MovistarBinarySensor, MOVISTAR_SCHEMA)
def movistar_binary_sensor(var, config):
    cg.add(
        var.set_data(
            cg.StructInitializer(
                MovistarData,
...
@register_trigger("movistar", MovistarTrigger, MovistarData)
def movistar_trigger(var, config):
    pass


@register_dumper("movistar", MovistarDumper)
def movistar_dumper(var, config):
    pass


@register_action("movistar", MovistarAction, MOVISTAR_SCHEMA)
async def movistar_action(var, config, args):
...
MovistarActionBase = ns.class_("MovistarActionBase", RemoteTransmitterActionBase)


@register_action(
    "movistar_OnOff",
    ns.class_("MovistarActionOnOff", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_OnOff(var, config, args):
    pass


@register_action(
    "movistar_Rojo",
    ns.class_("MovistarActionRojo", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Rojo(var, config, args):
    pass


@register_action(
    "movistar_Verde",
    ns.class_("MovistarActionVerde", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Verde(var, config, args):
    pass


@register_action(
    "movistar_Amarillo",
    ns.class_("MovistarActionAmarillo", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Amarillo(var, config, args):
    pass


@register_action(
    "movistar_Azul",
    ns.class_("MovistarActionAzul", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Azul(var, config, args):
    pass


@register_action(
    "movistar_Teclado",
    ns.class_("MovistarActionTeclado", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Teclado(var, config, args):
    pass


@register_action(
    "movistar_Persona",
    ns.class_("MovistarActionPersona", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Persona(var, config, args):
    pass


@register_action(
    "movistar_Ayuda",
    ns.class_("MovistarActionAyuda", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Ayuda(var, config, args):
    pass


@register_action(
    "movistar_SubirVolumen",
    ns.class_("MovistarActionSubirVolumen", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_SubirVolumen(var, config, args):
    pass


@register_action(
    "movistar_BajarVolumen",
    ns.class_("MovistarActionBajarVolumen", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_BajarVolumen(var, config, args):
    pass


@register_action(
    "movistar_SubirPrograma",
    ns.class_("MovistarActionSubirPrograma", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_SubirPrograma(var, config, args):
    pass


@register_action(
    "movistar_BajarPrograma",
    ns.class_("MovistarActionBajarPrograma", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_BajarPrograma(var, config, args):
    pass


@register_action(
    "movistar_Guia",
    ns.class_("MovistarActionGuia", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Guia(var, config, args):
    pass


@register_action(
    "movistar_Menu",
    ns.class_("MovistarActionMenu", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Menu(var, config, args):
    pass


@register_action(
    "movistar_Subir",
    ns.class_("MovistarActionSubir", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Subir(var, config, args):
    pass


@register_action(
    "movistar_Bajar",
    ns.class_("MovistarActionBajar", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Bajar(var, config, args):
    pass


@register_action(
    "movistar_Izquierda",
    ns.class_("MovistarActionIzquierda", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Izquierda(var, config, args):
    pass


@register_action(
    "movistar_Derecha",
    ns.class_("MovistarActionDerecha", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Derecha(var, config, args):
    pass


@register_action(
    "movistar_OK",
    ns.class_("MovistarActionOK", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_OK(var, config, args):
    pass


@register_action(
    "movistar_Atras",
    ns.class_("MovistarActionAtras", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Atras(var, config, args):
    pass


@register_action(
    "movistar_Mute",
    ns.class_("MovistarActionMute", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Mute(var, config, args):
    pass


@register_action(
    "movistar_Favoritos",
    ns.class_("MovistarActionFavoritos", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Favoritos(var, config, args):
    pass


@register_action(
    "movistar_Retroceder",
    ns.class_("MovistarActionRetroceder", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Retroceder(var, config, args):
    pass


@register_action(
    "movistar_PlayPause",
    ns.class_("MovistarActionPlayPause", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_PlayPause(var, config, args):
    pass


@register_action(
    "movistar_Avanzar",
    ns.class_("MovistarActionAvanzar", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Avanzar(var, config, args):
    pass


@register_action(
    "movistar_Parar",
    ns.class_("MovistarActionParar", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Parar(var, config, args):
    pass


@register_action(
    "movistar_Grabar",
    ns.class_("MovistarActionGrabar", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Grabar(var, config, args):
    pass


@register_action(
    "movistar_1",
    ns.class_("MovistarAction1", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_1(var, config, args):
    pass


@register_action(
    "movistar_2",
    ns.class_("MovistarAction2", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_2(var, config, args):
    pass


@register_action(
    "movistar_3",
    ns.class_("MovistarAction3", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_3(var, config, args):
    pass


@register_action(
    "movistar_4",
    ns.class_("MovistarAction4", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_4(var, config, args):
    pass


@register_action(
    "movistar_5",
    ns.class_("MovistarAction5", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_5(var, config, args):
    pass


@register_action(
    "movistar_6",
    ns.class_("MovistarAction6", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_6(var, config, args):
    pass


@register_action(
    "movistar_7",
    ns.class_("MovistarAction7", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_7(var, config, args):
    pass


@register_action(
    "movistar_8",
    ns.class_("MovistarAction8", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_8(var, config, args):
    pass


@register_action(
    "movistar_9",
    ns.class_("MovistarAction9", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_9(var, config, args):
    pass


@register_action(
    "movistar_0",
    ns.class_("MovistarAction0", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_0(var, config, args):
    pass


@register_action(
    "movistar_LineaAbajo",
    ns.class_("MovistarActionLineaAbajo", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_LineaAbajo(var, config, args):
    pass


@register_action(
    "movistar_Mensajes",
    ns.class_("MovistarActionMensajes", MovistarActionBase),
    cv.Schema({}),
)
async def movistar_action_Mensajes(var, config, args):
    pass
